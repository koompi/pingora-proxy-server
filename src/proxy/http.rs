...
impl ProxyHttp for HttpProxy {
    ...
    async fn request_filter(&self, session: &mut Session, _ctx: &mut Self::CTX) -> Result<bool> {
        ...
        if path.starts_with("/var/www/html/.well-known/acme-challenge/") {
            ...
            Some(to) => {
                ...
                if to.contains(".") || to.starts_with("tasks.") {
                    ...
                    if let Some(org) = org_id {
                        ...
                        peer.options
                            .extra_proxy_headers
                            .insert("X-Proxy-Source".to_string(), b"pingora-proxy".to_vec());
                    ...
                    peer.options
                        .extra_proxy_headers
                        .insert("X-Forwarded-Proto".to_string(), b"http".to_vec());
